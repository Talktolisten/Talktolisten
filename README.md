...
### Front-end
- Tech: Expo React Native, Redux, Firebase, Deepgram API, Axios
- [GitHub](https://github.com/Talktolisten/talktolisten-frontend)

### Back-end
- Tech: FastAPI(Python), PostgreSQL, SQLAlchemy, Firebase, Docker, GitHub Actions, AWS EC2, Nginx, Gunicorn, Alembic, Pydantic, Pytest, RESTful APIs.
